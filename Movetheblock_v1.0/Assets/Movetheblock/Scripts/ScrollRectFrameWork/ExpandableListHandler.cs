    ...
    public class ExpandableListHandler<T>
    {
        ...
        private void CreateListItemPlaceholders()
        {
            for (int i = 0; i < dataObjects.Count; i++)
            {
                ...
                // Debug.Log("CreateListItemPlaceholders " + ListItemSize);
        ...
        private void SetPlaceholderSize(int index, RectTransform placeholder, bool addingOnTop)
        {
            ...
            if (addingOnTop)
            {
                ...
                offset = ConvertOffSetGame();
              //  Debug.Log(string.Format("OffSet : {0}-{1}", listContainer.anchoredPosition.y, offset));
            ...
            //    Debug.Log("	placeholder.sizeDelta  " + placeholder.sizeDelta);
        ...
        /// <summary>
        /// In This Game OffSet return wrong 
        /// I convert value offset to zero
        /// if copy script to other game please remove  method ConvertOffSetGame()
        /// </summary>

        private float ConvertOffSetGame()
        {
            return 0;
        }
